...
const SLOT_POSITIONS: Record<Formation, Record<string, { x: number; y: number }>> = {
  ...
  "4-3-3": {
    GK: { x: 50, y: 92 },
    LB: { x: 15, y: 72 }, DC1: { x: 37, y: 75 }, DC2: { x: 63, y: 75 }, RB: { x: 85, y: 72 },
    DMC: { x: 50, y: 55 }, MCL: { x: 30, y: 48 }, MCR: { x: 70, y: 48 },
    LW: { x: 15, y: 22 }, ST1: { x: 50, y: 15 }, RW: { x: 85, y: 22 },
  },
  "4-2-3-1": {
    GK: { x: 50, y: 92 },
    LB: { x: 15, y: 72 }, DC1: { x: 37, y: 75 }, DC2: { x: 63, y: 75 }, RB: { x: 85, y: 72 },
    DMC: { x: 35, y: 55 }, MCC: { x: 65, y: 55 },
    LW: { x: 15, y: 35 }, AMC: { x: 50, y: 32 }, RW: { x: 85, y: 35 },
    ST1: { x: 50, y: 15 },
  },
  "3-5-2": {
    GK: { x: 50, y: 92 },
    DC1: { x: 30, y: 75 }, DC2: { x: 50, y: 78 }, DC3: { x: 70, y: 75 },
    LWB: { x: 10, y: 52 }, MCL: { x: 30, y: 48 }, MCC: { x: 50, y: 50 }, MCR: { x: 70, y: 48 }, RWB: { x: 90, y: 52 },
    ST1: { x: 35, y: 18 }, ST2: { x: 65, y: 18 },
  },
  "3-4-3": {
    GK: { x: 50, y: 92 },
    DC1: { x: 30, y: 75 }, DC2: { x: 50, y: 78 }, DC3: { x: 70, y: 75 },
    LWB: { x: 10, y: 52 }, MCL: { x: 37, y: 50 }, MCR: { x: 63, y: 50 }, RWB: { x: 90, y: 52 },
    LW: { x: 15, y: 22 }, ST1: { x: 50, y: 15 }, RW: { x: 85, y: 22 },
  },
  "5-3-2": {
    GK: { x: 50, y: 92 },
    LWB: { x: 10, y: 68 }, DC1: { x: 30, y: 75 }, DC2: { x: 50, y: 78 }, DC3: { x: 70, y: 75 }, RWB: { x: 90, y: 68 },
    MCL: { x: 30, y: 48 }, MCC: { x: 50, y: 50 }, MCR: { x: 70, y: 48 },
    ST1: { x: 35, y: 18 }, ST2: { x: 65, y: 18 },
  },
};
